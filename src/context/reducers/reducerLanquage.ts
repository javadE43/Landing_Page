...
//   key: sessionStorage.getItem("lan")?JSON.parse(`${sessionStorage.getItem("lan")}`)?.key:"",
//   language:sessionStorage.getItem("lan")?JSON.parse(`${sessionStorage.getItem("lan")}`)?.language:{},
//   data: {
//     fa: {},
//     en: {},
//   },
...
//         ? JSON.parse(`${sessionStorage.getItem("lan")}`).language
//         : null;
//       if (!local) {
//         return {
//           ...state,
